...
for (const marker of [
  ...
  'const APP_VERSION = "43-weekly-photo-report2"',
...
if (!sw.includes('task-hub-shell-v43-weekly-photo-report2')) throw new Error("El cache del Service Worker no fue actualizado");
