...
for (const marker of [
  ...
  'const APP_VERSION = "41-original-evidence-links1"',
...
if (!sw.includes('task-hub-shell-v41-original-evidence-links1')) throw new Error("El cache del Service Worker no fue actualizado");
