...
for (const marker of [
  ...
  'const APP_VERSION = "35-task-hub-no-evidence-links1"',
...
if (!sw.includes('task-hub-shell-v35-task-hub-no-evidence-links1')) throw new Error("El cache del Service Worker no fue actualizado");
