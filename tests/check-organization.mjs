...
for (const marker of [
  ...
  'const APP_VERSION = "34-task-hub-watchdog1"',
...
if (!sw.includes('task-hub-shell-v34-task-hub-watchdog1')) throw new Error("El cache del Service Worker no fue actualizado");
