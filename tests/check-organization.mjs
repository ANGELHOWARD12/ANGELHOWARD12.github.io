...
for (const marker of [
  ...
  'const APP_VERSION = "36-task-status-colors1"',
...
if (!sw.includes('task-hub-shell-v36-task-status-colors1')) throw new Error("El cache del Service Worker no fue actualizado");
