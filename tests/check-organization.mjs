...
for (const marker of [
  ...
  'const APP_VERSION = "40-weekly-evidence-download1"',
...
if (!sw.includes('task-hub-shell-v40-weekly-evidence-download1')) throw new Error("El cache del Service Worker no fue actualizado");
