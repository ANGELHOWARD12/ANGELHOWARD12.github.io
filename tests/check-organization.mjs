...
for (const marker of [
  ...
  'const APP_VERSION = "56-access-suspended"',
...
if (!sw.includes('task-hub-shell-v56-access-suspended')) throw new Error("El cache del Service Worker no fue actualizado");
