...
for (const marker of [
  ...
  'const APP_VERSION = "44-upload-resilience"',
...
if (!sw.includes('task-hub-shell-v44-upload-resilience')) throw new Error("El cache del Service Worker no fue actualizado");
