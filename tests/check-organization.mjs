...
for (const marker of [
  ...
  'const APP_VERSION = "33-task-hub-native1"',
...
if (!sw.includes('task-hub-shell-v33-task-hub-native1')) throw new Error("El cache del Service Worker no fue actualizado");
