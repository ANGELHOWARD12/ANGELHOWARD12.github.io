...
for (const marker of [
  ...
  'const APP_VERSION = "37-offline-continuity1"',
...
if (!sw.includes('task-hub-shell-v37-offline-continuity1')) throw new Error("El cache del Service Worker no fue actualizado");
